-- Nullspace builder-agent output for demand: monthly recurring revenue by segment 234417
-- Requesters: revenue-copilot-1.0.0, finance-agent-2.3.1, board-deck-writer-0.9.0
-- Ghost URN: urn:li:dataset:(urn:li:dataPlatform:nullspace,ghost_monthly_recurring_revenue_by_segment_234417_e2e283f5,PROD)
