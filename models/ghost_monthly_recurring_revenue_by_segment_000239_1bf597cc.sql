-- Nullspace builder-agent output for demand: monthly recurring revenue by segment 000239
-- Requesters: revenue-copilot-1.0.0, finance-agent-2.3.1, board-deck-writer-0.9.0
-- Ghost URN: urn:li:dataset:(urn:li:dataPlatform:nullspace,ghost_monthly_recurring_revenue_by_segment_000239_1bf597cc,PROD)
