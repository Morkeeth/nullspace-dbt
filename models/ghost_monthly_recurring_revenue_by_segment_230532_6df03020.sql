-- Nullspace builder-agent output for demand: monthly recurring revenue by segment 230532
-- Requesters: revenue-copilot-1.0.0, finance-agent-2.3.1, board-deck-writer-0.9.0
-- Ghost URN: urn:li:dataset:(urn:li:dataPlatform:nullspace,ghost_monthly_recurring_revenue_by_segment_230532_6df03020,PROD)
